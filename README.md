...
*   **[`Case_Studies/`](file:///c:/VESUVIUS_LOCAL/Case_Studies/)** (Public): Clinical case files and high-level FASCIA audit summaries (Boeing 737 MAX, Renault-Nissan alliance, Enron & Theranos, Vatican *Magnifica humanitas*, In-Ovo Sorting).
